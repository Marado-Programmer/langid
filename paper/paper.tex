...
\begin{document}
    ...
    \begin{figure}
        \begin{center}
            \begin{tikzpicture}[
                ...
                \node[neuron] (neuron_1) {1};
                \node[neuron] (neuron_2) [right=of neuron_1] {2};
                \node[var] (input) [left=of neuron_1] {$ \mathbf{x} $};
                \node[var] (output) [right=of neuron_2] {$ y $};

                \draw[->] (input.east) -- (neuron_1.west);
                \draw[->] (neuron_1.east) -- (neuron_2.west);
                \draw[->] (neuron_2.east) -- (output.west);
            \end{tikzpicture}
        \end{center}
    ...
    \begin{figure}
        \begin{center}
            \begin{tikzpicture}[
                ...
                \node[neuron] (neuron_1_1) {};
                \node[neuron] (neuron_1_2) [below=of neuron_1_1] {};
                \node[neuron] (neuron_1_3) [below=of neuron_1_2] {};
                \node[neuron] (neuron_1_4) [below=of neuron_1_3] {};
                \node[neuron] (neuron_1_5) [below=of neuron_1_4] {};
                \node[neuron] (neuron_2_1) [right=2cm of neuron_1_2] {};
                \node[neuron] (neuron_2_2) [right=2cm of neuron_1_4] {};
                \node[var] (input_m) [left=2cm of neuron_1_3] {$ \vdots $};
                \node[var] (input_i) [above=of input_m] {$ \mathbf{x}_{1} $};
                \node[var] (input_f) [below=of input_m] {$ \mathbf{x}_{D} $};
                \node[var] (output) [below right=of neuron_2_1] {$ y $};
                \node[var] (layer1) [above=of neuron_1_1] {1\textsuperscript{st} layer};
                \node[var] (layer2) [above=of neuron_2_1] {2\textsuperscript{nd} layer};

                \draw[->] (input_i.east) -- (neuron_1_1.west);
                \draw[->] (input_i.east) -- (neuron_1_2.west);
                \draw[->] (input_i.east) -- (neuron_1_3.west);
                \draw[->] (input_i.east) -- (neuron_1_4.west);
                \draw[->] (input_i.east) -- (neuron_1_5.west);
                \draw[->] (input_f.east) -- (neuron_1_1.west);
                \draw[->] (input_f.east) -- (neuron_1_2.west);
                \draw[->] (input_f.east) -- (neuron_1_3.west);
                \draw[->] (input_f.east) -- (neuron_1_4.west);
                \draw[->] (input_f.east) -- (neuron_1_5.west);
                \draw[->] (neuron_1_1.east) -- (neuron_2_1.west);
                \draw[->] (neuron_1_1.east) -- (neuron_2_2.west);
                \draw[->] (neuron_1_2.east) -- (neuron_2_1.west);
                \draw[->] (neuron_1_2.east) -- (neuron_2_2.west);
                \draw[->] (neuron_1_3.east) -- (neuron_2_1.west);
                \draw[->] (neuron_1_3.east) -- (neuron_2_2.west);
                \draw[->] (neuron_1_4.east) -- (neuron_2_1.west);
                \draw[->] (neuron_1_4.east) -- (neuron_2_2.west);
                \draw[->] (neuron_1_5.east) -- (neuron_2_1.west);
                \draw[->] (neuron_1_5.east) -- (neuron_2_2.west);
                \draw[->] (neuron_2_1.east) -- (output.west);
                \draw[->] (neuron_2_2.east) -- (output.west);
            \end{tikzpicture}
        \end{center}
        \caption{Two layer neural network, first layer has 5 neurons and the
        second one 2.}\label{fig:network}
    \end{figure}
    ...
    % \begin{figure}
    %     \begin{center}
    %         %\includegraphics[width=0.95\textwidth]{./res/double.jpeg}
    %         \input{./res/doubles.tex}
    %     \end{center}
    %     \caption{Change of error function on neural network to compute $ y = 2x
    %     $. The function y is the value the network is returning for one of the
    %     input training data.}\label{fig:doubles}
    % \end{figure}
    ...
    %     \end{center}
    %     \caption{Change of error function on neural network to compute $ y =
    %     \sin \left( x \right) $. The function y is the value the network is
    %     returning for one of the input training data.}\label{fig:sin}
    % \end{wrapfigure}
    % \begin{wrapfigure}{R}{0.48\textwidth}
    %     \begin{center}
    %         \input{./res/linear.tex}
    %     \end{center}
    %     \caption{Change of error function on neural network to compute $ y = ax
    %     + b $. The function y is the value the network is returning for one of
    %     the input training data.}\label{fig:linear}
    % \end{wrapfigure}
    % \begin{wrapfigure}{L}{0.48\textwidth}
    %     \begin{center}
    %         \input{./res/parabola.tex}
    %     \end{center}
    %     \caption{Change of error function on neural network to compute $ y =
    %     ax^{2} + bx + c $. The function y is the value the network is returning
    %     for one of the input training data.}\label{fig:parabola}
    % \end{wrapfigure}
